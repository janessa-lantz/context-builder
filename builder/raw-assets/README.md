...
- **Hosted**: a live URL (a blog post, a web page). It lives at its URL. The builder reads it on demand and keeps only the summary. The `source` in the [content index](../../context/content-index.md) is the URL, and nothing is stored here.
