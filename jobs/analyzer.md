...
[parsed summaries](../builder/parsed-summaries/), the
[canon](../context/messaging-canon.md), and competitor [entity Profiles](../builder/entities/), produces structured findings, and writes them to
...
- **competitive**: a competitor contests the canon. Compares the canon against competitor [entity Profiles](../builder/entities/), component by component, and flags where a competitor occupies, matches, or undercuts a component the canon claims. Competitor Profiles are raw intelligence, so a competitive issue flags pressure for you to judge, never a change to make.
